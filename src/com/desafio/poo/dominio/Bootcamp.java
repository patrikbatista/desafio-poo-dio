...
public class Bootcamp {
    ...
    private Set<Dev> devsInscritos = new HashSet<>(); //usa-se HashSet pq a ordem dos devs que forem incritos é irrelevante
    private Set<Conteudo> conteudos = new LinkedHashSet<>(); //usa-se LinkedHashSet pois a ordem dos cursos são importantes
